                ...
                <form>
                    <div className="row">
                        <div className="col col-6 box-form">
                            <label className="label-form" htmlFor="inputname">Nombre de la Empresa</label>
                            <input type="text" className="form-control" id="inputname" aria-describedby="nameHelp" />
                        </div>
                        <div className="col col-6 box-form">
                            <label className="label-form" htmlFor="inputlastname">Razon Social</label>
                            <input type="text" className="form-control" id="inputlastname" />
                        </div>
                        <div className="col col-6 box-form">
                            <label className="label-form" htmlFor="inputci">Numero de N.I.T.</label>
                            <input type="text" className="form-control" id="inputci" />
                        </div>
                        <div className="col col-6 box-form">
                        ...
                        <div className="col col-6 box-form">
                            <label className="label-form">Logo de Empresa</label>
