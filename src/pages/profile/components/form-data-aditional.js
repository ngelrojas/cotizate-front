  ...
  submitUpdateAdd = async e => {
    ...
    if (this.validateForm()) {
      await API.put(
        ...
        .catch(err => {
          this.setState({
            msg: 'por favor revise que todos los campos esten completos.',
          })
          console.log(err)
        })
    }
  ...
  render() {
    return (
      <div className="wrapper-personal-data-add">
        <form
          method="POST"
          className="form form-update-add"
          onSubmit={this.submitUpdateAdd}>
          <div className="form-inputs">
            <h4>
              <Tooltip
                label="DATOS PERSONALES COMPLEMENTARIOS"
          ...
          <div className="row">
            <div className="col-6 form-side-lef">
              ...
              <div className="col-10 form-group form-inputs">
                ...
                <input
                  ...
                  defaultChecked={
                    this.state.fields.is_representative
            ...
            <div className="col-6 form-side-righ">
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Telefono Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Direccion Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Logotipo Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <div className="img-company-logo">
                  <img
                    src={this.state.fields.company_logo || ''}
                    alt="cotizate"
                  />
                </div>
                <input
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Descripcion Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Facebook Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Twitter Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'LinkdIn Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
              ...
              <div className="col-10 form-group form-inputs">
                <Tooltip
                  label={'Instagram Compañia/Empresa'}
                  text={'aqui el texto'}
                />
                <input
                  type="text"
